        ...
        <div>
            <b-navbar toggleable="lg" type="dark" variant="dark">
                ...
                <b-collapse id="nav-collapse" is-nav type="dark">
                    <b-nav-item-dropdown text="Board" v-if="this.admin">
                        <b-dropdown-item to="/board">Boards</b-dropdown-item>
                        <b-dropdown-item to="/board/create">BoardsCreate</b-dropdown-item>
                    </b-nav-item-dropdown>
                    <b-navbar-nav class="">
